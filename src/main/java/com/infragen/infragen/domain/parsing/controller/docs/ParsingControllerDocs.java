package com.infragen.infragen.domain.parsing.controller.docs;
...
@Tag(name = "Generate API", description = "캔버스 그래프 검증·파싱 후 IaC 파일 생성 API (LOCAL_DEV: docker-compose.yml + .env)")
public interface ParsingControllerDocs {
