...
// JwtUtil 클래스의 생성자 부분에 @Value 어노테이션으로 application.yml 파일의 내용을 직접적으로 읽어들이지 않고, 스프링 빈으로써 관리
@Getter
@Setter // yaml의 값을 필드에 주입하기 위해 Setter가 필요 (ConfigurationProperties의 작동 원리, Jackson 라이브러리)
@Configuration
