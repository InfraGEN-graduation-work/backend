...
public enum ParsingErrorCode implements BaseErrorCode {
    ...
    MISSING_SPRING_BOOT_CONTAINER_NAME(
            HttpStatus.BAD_REQUEST,
            "Spring Boot 컨테이너 이름이 누락되었습니다.",
            "PARSING400_20"
    ),
    MISSING_MYSQL_CONTAINER_NAME(
            HttpStatus.BAD_REQUEST,
            "MySQL 컨테이너 이름이 누락되었습니다.",
            "PARSING400_21"
    ),
    MISSING_MYSQL_VOLUME_NAME(
            HttpStatus.BAD_REQUEST,
            "MySQL 볼륨 이름이 누락되었습니다.",
            "PARSING400_22"
    );
