...
class MySQLParserTest {
    ...
    @Test
    @DisplayName("containerName 누락 — MISSING_MYSQL_CONTAINER_NAME")
    void parse_MissingContainerName_ThrowsParsingException() {
        ...
        // then
        assertEquals(
            ParsingErrorCode.MISSING_MYSQL_CONTAINER_NAME,
            exception.getCode()
        );
    }

    @Test
    @DisplayName("volumeName 누락 — MISSING_MYSQL_VOLUME_NAME")
    void parse_MissingVolumeName_ThrowsParsingException() {
        // given
        Map<String, Object> properties = validProperties();
        ...
        // then
        assertEquals(
            ParsingErrorCode.MISSING_MYSQL_VOLUME_NAME,
            exception.getCode()
        );
    }
